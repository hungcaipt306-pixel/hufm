...
## Cập nhật tài khoản và Công cụ PWA
- Đăng ký và tạo tài khoản mới sử dụng **tên đăng nhập**, không yêu cầu email.
...
## Cập nhật v32 – Giao diện lớp bản đồ hiện trường

- Giao diện bản đồ toàn màn hình trên điện thoại, nút lớp ở góc trái dưới, định vị/cập nhật ở cạnh phải và zoom ở góc phải dưới.
- Bảng lớp mới gồm Google vệ tinh có nhãn, Google vệ tinh chuẩn, OpenStreetMap và địa hình.
- Mỗi lớp GeoJSON/KML tải lên có bật/tắt, độ mờ, màu đường/vùng, trường nhãn, màu nhãn và cỡ nhãn.
- Popup thuộc tính đồng bộ với trường nhãn được chọn, không còn hiển thị chuỗi HTML `<br/>` thô.
- Có tải xuống lớp dữ liệu và lưu tùy chỉnh theo thiết bị.
